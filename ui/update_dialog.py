...
class UpdateDialog(QDialog):
    ...
    def _make_card(self, label: str, value: str) -> QWidget:
        # ... (rest of _make_card remains the same)
        w = QWidget()
        v = QVBoxLayout(w)
        title = QLabel(label)
        ...
        val = QLabel(style_value)
        val.setStyleSheet(f"color:{style_color}; background:#fafafa; border:1px solid #ddd; padding:8px; border-radius:6px; font-weight:bold;")
